...
export default function Index({ presensis, karyawan, filters }) {
    ...
    const handleFilter = () => {
        router.get(route("attendance.presensi.index"), { tanggal, karyawan_id: karyawanId, status_validasi: status });
    };
        ...
        <AuthenticatedLayout>
            ...
            <div className="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">Rekap check-in / check-out karyawan di lapangan</p>
                </div>
                <Link
